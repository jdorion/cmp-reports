 /**
 * jQuery jPages v0.7 - CUSTOM
 * Customizations to fit WET v4 & Bootstrap pagination theme
...
;(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    setStyles : function() {
      ...
      ".wb-inv { visibility: hidden !important; } " +
      ...
      if (this._cssAnimSupport && this.options.animation.length)
        this._items.addClass("animated hidden");
    ...
    writeNav : function() {
      ...
      for (; i <= this._numPages; i++) {
        ...
        if (i > this.options.startRange && i <= this._numPages - this.options.endRange)
          navhtml += "<li><a href='#' class='hidden'>";
        else
          navhtml += "<li><a>";
    ...
    writeBtn : function(which) {
      ...
      "<li><a class='" + which + "'>" + this.options[which] + "</a></li>" : "";
    ...
    cacheNavElements : function(holder, index) {
      ...
      this._nav[index].pages = this._nav[index].holder.find("a").not(".irst, .previous, .next, .last");
    ...
    cssAnimations : function(page) {
      ...
      this._itemsHiding
        .removeClass(this.options.animation + " wb-inv")
        .addClass("hidden");
    ...
    jQAnimations : function(page) {
      clearInterval(this._delay);
      this._itemsHiding.addClass("hidden");
      this._itemsShowing.fadeTo(0, 0).removeClass("hidden");
      this._itemsOriented = this.getDirectedItems(page);
      this._index = 0;
      this._delay = setInterval(this.bind(function() {
        if (this._index === this._itemsOriented.length) clearInterval(this._delay);
    ...
    updatePagesShowing : function(nav, interval) {
      ...
      nav.pagesShowing.not(newRange).addClass("hidden");
      newRange.not(nav.pagesShowing).removeClass("hidden");
    ...
    updateBreaks : function(nav, interval) {
      ...
      ) nav.fstBreak.removeClass("hidden");
      else nav.fstBreak.addClass("hidden");

      if (interval.end < this._numPages - this.options.endRange) nav.lstBreak.removeClass("hidden");
      else nav.lstBreak.addClass("hidden");
    },
    ...
    destroy : function() {
      ...
      if (this._cssAnimSupport && this.options.animation.length)
        this._items.removeClass("animated hidden wb-inv " + this.options.animation);
      else this._items.removeClass("hidden").fadeTo(0, 1);
