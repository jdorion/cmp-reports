...
( function() {
	...
	CKEDITOR.tools.extend( CKEDITOR.editor.prototype, {
		 ...
		 *
		 *		var element = CKEDITOR.dom.element.createFromHtml( '<img src="../../ckeditor/core/hello.png" border="0" title="Hello" />' );
		 ...
		 *
		 * **Note:** This method should not be used to configure editor – use {@link CKEDITOR.config#enterMode} and
		 ...
		 * – see {@link CKEDITOR.editor#blockless}) only {@link CKEDITOR#ENTER_BR} is a valid enter mode. Therefore
 ...
 * Currently only one rule exists – {@link #blockless blockless editors} may have
